...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // FabCoin: 1 days
static const int64 nTargetSpacing = 120; // FabCoin: 2 minute blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // Fabcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Fabcoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
