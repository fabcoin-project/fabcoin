SmallChange (SMC) - a 'faster' version of Fabcoin which also uses scrypt
as a proof of work scheme and is intended for microtransactions.
 ...
 - currently no block checkpoints are in the code (but could be easily
   added)
Other than that, this coin is exactly like Fabcoin and should by no
...
So actually, this 'new' coin exists for the following reasons:
 - SMC proves that really anyone(!) can start a Fabcoin/Bitcoin based currency
    (just look at the changes I applied to the original Fabcoin source,
...
official, stable release versions of Fabcoin.
